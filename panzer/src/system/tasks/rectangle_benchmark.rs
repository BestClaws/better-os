...
use gfx::primitives::{
    reset_temp_allocation_peak, temp_allocation_peak_bytes, CornerRadius, FillStyle, Gradient,
    GradientStop, Rectangle, StrokeColor, StrokeStyle,
};
            ...
            for stroke_idx in 0..9 {
                ...
                let (stroke_name, edges): (&str, [Option<StrokeStyle<2>>; 4]) = match stroke_idx {
                    ...
                    1 => (
                        ...
                        [
                            Some(StrokeStyle {
                                color: StrokeColor::<2>::Solid(Color::rgba(255, 255, 255, 255)),
                    ...
                    5 => (
                        ...
                        [
                            Some(StrokeStyle {
                                color: StrokeColor::<2>::Solid(Color::rgba(255, 100, 100, 255)),
                                stroke: Stroke::new(2.0),
                            }),
                            Some(StrokeStyle {
                                color: StrokeColor::<2>::Solid(Color::rgba(100, 255, 100, 255)),
                                stroke: Stroke::new(2.0),
                            }),
                            Some(StrokeStyle {
                                color: StrokeColor::<2>::Solid(Color::rgba(100, 100, 255, 255)),
                                stroke: Stroke::new(2.0),
                            }),
                            Some(StrokeStyle {
                                color: StrokeColor::<2>::Solid(Color::rgba(255, 255, 100, 255)),
                                stroke: Stroke::new(2.0),
                            }),
                        ],
                    ),
                    6 => (
                        ...
                        [
                            Some(StrokeStyle {
                                color: StrokeColor::<2>::Gradient(Gradient::Horizontal(
                                    GradientStop([
                    ...
                    7 => (
                        ...
                        [
                            Some(StrokeStyle {
                                color: StrokeColor::<2>::Gradient(Gradient::Vertical(
                                    GradientStop([
                ...
                let alloc_peak = temp_allocation_peak_bytes();

                info!(
                    "{}_rect_{:03}_{}_{}_{}  {} µs, peak tmp alloc {} B",
                    format_prefix,
                    test_num,
                    fill_name,
                    corner_name,

use rust_gfx::{Arc, Circle, Line, Rgb565Rasterizer, Rgba8888, RoundedRect, Shape};
use std::fs::File;
...
fn main() {
    ...
    let circle = Circle::new(60, 60, 40).fill_solid(Rgba8888::rgb(255, 0, 0));
    circle.draw(&mut rasterizer);

    // Test 2: Stroked circle with AA
    let circle2 = Circle::new(180, 60, 30).stroke(3, Rgba8888::rgb(0, 255, 0));
    ...
    // Test 4: Arc
    let arc = Arc::new(180, 160, 35, 0, 270).stroke(4, Rgba8888::rgb(255, 0, 255));
    arc.draw(&mut rasterizer);

    // Test 5: Line
    let line = Line::new(20, 200, 220, 220).stroke(2, Rgba8888::rgb(255, 255, 255));

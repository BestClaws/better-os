...
fn main() {
    ...
    println!(
        "  core: ({},{})-({},{})",
        core.x1, core.y1, core.x2, core.y2
    );
    ...
    println!(
        "  (30,30): {:?} (should be yellow, in straight edge)",
        canvas.get_pixel(30, 30)
    );
    println!(
        "  (72,30): {:?} (should be yellow, in straight edge)",
        canvas.get_pixel(72, 30)
    );
